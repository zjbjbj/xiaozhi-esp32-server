...
export default {
  ...
  // About us
  'settings.aboutApp': 'About XiaoA Console',
  'settings.aboutContent': 'XiaoA Console\n\n agent configuration and other functions for xiaozhi ESP32 smart hardware.\n\n© 2026 xiaoia-server {version}',
